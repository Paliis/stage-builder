...
locale: en
discipline: rifle
control_values: "Verify Rifle Jan 2026 PDF — 10.2.5 (cover geometry and shot)"
ipsc_edition: "Jan 2026"
ipsc_refs:
  - rule: "10.2.5"
    note: "Overhead / Cooper tunnel type shots — Rifle Jan 2026; full text in PDF"
...
**Cooper tunnel** in IPSC slang describes a pattern where the competitor **“covers”** a port (approach from above / specific geometry relative to a window or tunnel), and **Rifle** **10.2.5** states **when** such behaviour with a shot incurs **procedural** (or other outcome). **Rifle** long-gun geometry at ports differs from **handgun** — read **Rifle** **Chapter 10** only. Exact criteria and exceptions are **only** from the **Jan 2026** PDF — do not confuse with **10.2.11** if the rulebook separates the cases.

## What the Range Officer (RO) does

1. **Observe:** how the competitor enters the window / tunnel; body and **rifle** position; whether a shot occurs in a disputed posture.
...
- Anchor: **10.2.5** in **Rifle** **Chapter 10**; cross-check **10.2.11** if it looks like a forbidden shot over/through cover.
...
- **Handgun-only** sightlines for **rifle** ports without reading **Rifle** PDF.
