...
locale: en
discipline: rifle
control_values: "Verify Rifle Jan 2026 PDF — 10.2.3 (what the cap attaches to)"
...
**10.2.3** limits **how many** times (or to what ceiling) **procedural** penalties may accrue in a defined context — e.g. per **shot**, **target**, **stage**, or another unit **exactly as the Jan 2026 Rifle PDF states**. This is a **cap rule** for a specific class of violations — read **Rifle** **Chapter 10**, not **Handgun** alone.
...
- Anchor: **10.2.3** in **Rifle**; read together with the sub-rules the cap references.
