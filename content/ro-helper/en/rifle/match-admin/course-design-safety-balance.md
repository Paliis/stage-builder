...
**1.1** states **principles** for IPSC courses: **safety**, **fairness** across divisions, **balance** of shooting vs movement, etc. **ROs** rarely **design** stages but **must** stop obvious hazards or impossible **WSB** execution and report to **CRO/RM** **before** squads shoot. **C305** = **Handgun** — use the **Rifle** PDF for **1.1**.
...
- Using **Handgun 1.1** **without** opening the **Rifle** PDF.
