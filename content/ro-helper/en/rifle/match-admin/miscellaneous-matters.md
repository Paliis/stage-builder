...
locale: en
discipline: rifle
control_values: "Verify Rifle Jan 2026 PDF — Ch.12 (residual administrative items)"
...
**Chapter 12** collects **miscellaneous** items that do not fit other chapters (**exact list in the Jan 2026** PDF). For **ROs** it is mainly a **lookup**: when a question does not fall under **Chapters 2–11**, check **12** before improvising. **C295** = **Handgun** — use the **Rifle** PDF for **Chapter 12**.
...
- Read **Chapter 12 Rifle** for admin gaps not covered elsewhere in the card pack.
...
- Using **Handgun Ch.12** **without** opening the **Rifle** PDF.
