...
locale: en
discipline: shotgun
control_values: "Verify Shotgun Jan 2026 PDF — 10.2.3 (what the cap attaches to)"
ipsc_edition: "Jan 2026"
ipsc_refs:
  - rule: "10.2.3"
    note: "Maximum procedural in a defined context — Shotgun Jan 2026; PDF only"
...
**10.2.3** limits **how many** times (or to what ceiling) **procedural** penalties may accrue in a defined context — e.g. per **shot**, **target**, **array**, **stage**, or another unit **exactly as the Jan 2026 Shotgun PDF states**. This is a **cap rule** for a specific class of violations — read **Shotgun** **Chapter 10**, not **Handgun** alone.
...
- **Wrong “container”:** cap per shot vs per target vs per array — category error.
