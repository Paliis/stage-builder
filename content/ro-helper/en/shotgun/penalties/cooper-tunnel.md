...
locale: en
discipline: shotgun
control_values: "Verify Shotgun Jan 2026 PDF — 10.2.5 (cover geometry and shot)"
ipsc_edition: "Jan 2026"
ipsc_refs:
  - rule: "10.2.5"
    note: "Overhead / Cooper tunnel type shots — Shotgun Jan 2026; full text in PDF"
...
**Cooper tunnel** in IPSC slang describes a pattern where the competitor **“covers”** a port (approach from above / specific geometry relative to a window or tunnel), and **Shotgun** **10.2.5** states **when** such behaviour with a shot incurs **procedural** (or other outcome). **Shotgun** mount, muzzle height, and movement between arrays differ from **handgun** — read **Shotgun** **Chapter 10** only. Exact criteria and exceptions are **only** from the **Jan 2026** PDF — do not confuse with **10.2.11** if the rulebook separates the cases.

## What the Range Officer (RO) does

1. **Observe:** how the competitor enters the window / tunnel; body and **shotgun** position; whether a shot occurs in a disputed posture.
...
- Anchor: **10.2.5** in **Shotgun** **Chapter 10**; cross-check **10.2.11** if it looks like a forbidden shot over/through cover.
...
- **Handgun-only** sightlines for **shotgun** ports without **Shotgun** PDF.
