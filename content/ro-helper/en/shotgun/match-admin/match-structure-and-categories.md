...
locale: en
discipline: shotgun
control_values: "Verify Shotgun Jan 2026 PDF — Ch.6 (stages, teams, classes, progression)"
...
**Chapter 6** of **IPSC Shotgun** covers **match organisation**: stages, **teams**, **categories**, progression rules. The bay **RO** rarely builds the schedule but should **know** whether the current string is in an allowed phase, how many **attempts** exist, and where to **send** questions on **class** or **team composition**. **C280** = **Handgun** — use the **Shotgun** PDF for **Chapter 6**.
...
- Using **Handgun Ch.6** **without** opening the **Shotgun** PDF.
