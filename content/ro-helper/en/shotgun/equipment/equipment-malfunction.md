...
locale: en
discipline: shotgun
control_values: "Verify Shotgun Jan 2026 PDF — matrix cites 5.7; confirm actual clause (may overlap PF / Ch.4 reshoot)"
ipsc_edition: "Jan 2026"
ipsc_refs:
  - rule: "5.7"
    note: "Matrix anchor — Shotgun; confirm in PDF malfunction vs PF wording"
...
An **equipment malfunction** during a match is when the **shotgun**, **tube / magazine**, **optic**, **loader**, or other allowed gear **fails** without competitor fault (failure to feed, broken carrier, etc.). Under **Shotgun Jan 2026**, whether you **stop**, **reshoot**, or **score as-is** depends on the **exact PDF clause** (matrix cites **5.7** — **verify** overlap with **PF** vs malfunction / **Chapter 4** reshoots). **C265** = **Handgun** — use the **Shotgun** PDF.
...
- **RO clears** or **fixes** the shotgun on the bay — not allowed; only the competitor in the **Safety Area** per rules.
- Using **Handgun** malfunction text **without** opening the **Shotgun** PDF.
