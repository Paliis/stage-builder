...
locale: en
discipline: handgun
control_values: "Verify Handgun Jan 2026 PDF — Ch.7 (MD, RM, CRO, RO powers)"
ipsc_edition: "Jan 2026"
ipsc_refs:
  - rule: "7"
    note: "Officials — MD / RM / RO — Handgun Ch.7"
...
**Chapter 7** defines the **officials chain**: the **Match Director (MD)** runs the overall event; the **Range Master (RM)** owns safety, rule interpretation, and on-site decisions; the **Chief Range Officer (CRO)** coordinates bays; the **RO** runs the **COF** on their bay. An **RO** does **not** replace the **RM** on **DQ**, match structure, or post-publication **WSB** changes.
...
- Anchor: **Chapter 7**; confirm **jury** / **arbitration** powers for your match level in the PDF.
