...
School/club simplifications must not erase required targets without **MD** authority aligned to rules tier. **`fpsu_delta_verified`**: **true** until **RO_HELPER_V0 §4.1** review.
