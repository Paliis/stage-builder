...
control_values: "Verify Mini Rifle Jan 2026 PDF — outcome under 8.6.2 (procedural / other)"
ipsc_edition: "Jan 2026"
ipsc_refs:
  - rule: "8.6.2"
    note: "Assistance to competitor outside what is allowed — Mini Rifle Jan 2026; read full 8.6"
...
**Unauthorized assistance** is when someone helps the competitor in a way that violates **Section 8.6** of the rules. Sub-rule **8.6.2** in **IPSC Mini Rifle Jan 2026** covers a specific case / consequence — **always** read the **full** **8.6** text in the **Mini Rifle** PDF. Do not substitute **Handgun** or full **Rifle** **8.6** wording without verifying **Mini Rifle**.
...
- Anchor: **8.6.2** in the context of all of **8.6** in the **Mini Rifle** rulebook (per PDF).
