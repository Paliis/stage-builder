...
control_values: "Verify Mini Rifle Jan 2026 PDF — matrix cites 5.7; confirm actual clause (may overlap PF / Ch.4 reshoot)"
ipsc_edition: "Jan 2026"
ipsc_refs:
  - rule: "5.7"
    note: "Matrix anchor — Mini Rifle; confirm in PDF malfunction vs PF wording"
...
An **equipment malfunction** during a match is when the **Mini Rifle**, **magazine**, **optic**, or other allowed gear **fails** without competitor fault. Under **Mini Rifle Jan 2026**, whether you **stop**, **reshoot**, or **score as-is** depends on the **exact PDF clause** (matrix cites **5.7** — **verify** overlap with **PF** vs malfunction / **Chapter 4** reshoots). **C265** = **Handgun** — use the **Mini Rifle** PDF (do not assume **full Rifle** or **handgun** outcomes without reading).
...
- Read the PDF: **malfunction** vs **user error** vs **safety breach** — different outcomes.
...
- **RO repairs** the rifle on the bay — not allowed; only the competitor in the **Safety Area** per rules.
- Using **Handgun** or **full Rifle** malfunction text **without** opening the **Mini Rifle** PDF.
