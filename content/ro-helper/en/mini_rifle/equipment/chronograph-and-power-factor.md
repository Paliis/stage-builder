...
control_values: "Verify Mini Rifle Jan 2026 PDF — 5.6–5.7 (Major/Minor PF, procedure, reshoot)"
...
**5.6** and **5.7** govern **chronograph** use and **power factor (PF)** for **Mini Rifle**: when testing happens, shot count, **Major** / **Minor** thresholds, **low PF**, retests, etc. The bay **RO** usually does not run chrono — but must know a competitor **without valid PF** must not shoot a division that requires a higher factor, and where to **redirect** after the **chrono official** rules. **C245** = **Handgun** — use the **Mini Rifle** PDF for **Chapter 5** numbers.
...
- **5.6–5.7 Mini Rifle** plus PF tables in **Chapter 5** / appendices; align with division (**Major/Minor**).
...
- **RO shoots someone else’s rifle** for PF without procedure.
- **Ignoring** mandatory re-chrono after a loadout change.
- Using **Handgun** or **full Rifle** **5.6–5.7** text **without** opening the **Mini Rifle** rulebook.
