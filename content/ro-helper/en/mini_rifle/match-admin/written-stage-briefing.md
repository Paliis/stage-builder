...
control_values: "Verify Mini Rifle Jan 2026 PDF — 3.2 (mandatory WSB contents, authority)"
...
**3.2** defines what a **written stage briefing (WSB)** must contain and how it binds the **COF** for **Mini Rifle**. The **RO applies the WSB on the bay**; if something is **not written**, general IPSC rules usually apply — not a private oral deal with the **MD** unless published per procedure. **C270** = **Handgun** — use the **Mini Rifle** PDF for **3.2** text (do not assume **full Rifle** or **handgun** WSB wording without checking).
...
- Using **Handgun** or **full Rifle** **3.2** **without** opening the **Mini Rifle** PDF.
