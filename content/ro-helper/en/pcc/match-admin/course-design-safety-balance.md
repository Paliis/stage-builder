...
locale: en
discipline: pcc
control_values: "Verify PCC Jan 2026 PDF — 1.1 (safety, balance, fair COF)"
...
**1.1** states **principles** for IPSC courses: **safety** for competitors and staff, **fairness** across divisions, **balance** of shooting vs movement, etc. **ROs** rarely **design** stages but **must** stop obvious hazards or impossible **WSB** execution and report to **CRO/RM** **before** squads shoot. **C305** = **Handgun** — use the **PCC** PDF for **1.1**.
...
- Using **Handgun 1.1** **without** opening the **PCC** PDF.
