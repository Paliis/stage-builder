...
locale: en
discipline: pcc
control_values: "Verify PCC Jan 2026 PDF — Ch.12 (residual administrative items)"
ipsc_edition: "Jan 2026"
ipsc_refs:
  - rule: "12"
    note: "Miscellaneous — PCC Ch.12"
...
**Chapter 12** collects **miscellaneous** items that do not fit other chapters (match language, small admin rules, transitional clauses, etc. — **exact list in the Jan 2026** PDF). For **ROs** it is mainly a **lookup**: when a question does not fall under **Chapters 2–11**, check **12** before improvising. **C295** = **Handgun** — use the **PCC** PDF for **Chapter 12**.
...
- Read **Chapter 12 PCC** for admin gaps not covered elsewhere in the card pack.
...
- Using **Handgun Ch.12** **without** opening the **PCC** PDF.
