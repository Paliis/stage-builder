...
locale: en
discipline: pcc
control_values: "Verify PCC Jan 2026 PDF — 5.6–5.7 (Major/Minor PF, procedure, reshoot)"
ipsc_edition: "Jan 2026"
ipsc_refs:
  - rule: "5.6"
    note: "Chronograph — PCC"
  - rule: "5.7"
...
**5.6** and **5.7** govern **chronograph** use and **power factor (PF)** for **PCC**: when testing happens, how many shots, **Major** / **Minor** thresholds, **low PF**, retests, etc. The bay **RO** usually does not run chrono — but must know a competitor **without valid PF** must not shoot a division that requires a higher factor, and where to **redirect** after the **chrono official** rules. **C245** = **Handgun** — use the **PCC** PDF for **Chapter 5** numbers.
...
- **5.6–5.7 PCC** plus PF tables in **Chapter 5** / appendices; align with division (**Major/Minor**).
...
- **RO shoots someone else’s carbine** for PF without procedure.
- **Ignoring** mandatory re-chrono after a loadout change.
- Using **Handgun** **5.6–5.7** text **without** opening the **PCC** rulebook.
