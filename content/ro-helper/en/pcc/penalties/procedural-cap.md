...
locale: en
discipline: pcc
control_values: "Verify PCC Jan 2026 PDF — 10.2.3 (what the cap attaches to)"
ipsc_edition: "Jan 2026"
ipsc_refs:
  - rule: "10.2.3"
    note: "Maximum procedural in a defined context — PCC Jan 2026; PDF only"
...
**10.2.3** limits **how many** times (or to what ceiling) **procedural** penalties may accrue in a defined context — e.g. per **shot**, **target**, **stage**, or another unit **exactly as the Jan 2026 PCC PDF states**. This is a **cap rule** for a specific class of violations — read **PCC** **Chapter 10**, not **Handgun** alone.
...
- Anchor: **10.2.3** in **PCC**; read together with the sub-rules the cap references.
