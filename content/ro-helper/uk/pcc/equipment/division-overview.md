...
**Розділ 5** **IPSC PCC** і **додатки** задають **дивізіони PCC** та **обмеження спорядження** (приклади, оптика, магазини — **точні** назви й ліміти в **PCC Jan 2026**). **C255** — **Handgun**; дивізіони **PCC** ≠ handgun. На **змішаних** майданчиках — різні книги правил.
