...
locale: uk
discipline: pcc
control_values: "Перевірити PDF PCC Jan 2026 — матриця вказує 5.7; звірити з повним текстом (можливі перехрестя з PF і розділом 4 про перестріл)"
ipsc_edition: "Jan 2026"
ipsc_refs:
  - rule: "5.7"
    note: "Matrix anchor — PCC; уточнити в PDF фактичний пункт для malfunction vs PF"
...
**Несправність спорядження** під час змагання — це коли **PCC**, **магазин**, **оптика** або інше дозволене спорядження **не працює** без вини спортсмена (затвор не закривається, відмова спуску, поломка магазину тощо). У **PCC Jan 2026** процедура **зупинки**, **перестрілу** або **заліковки** залежить від **конкретного пункту** у PDF (матриця картки посилається на **5.7** — **обов’язково звірити** з текстом **PF** чи окремим абзацом про несправність / перестріл у **розділі 4**). **C265** — **Handgun**; потрібен **PDF PCC**.
...
- **RO ремонтує** карабін на лінії — заборонено; лише спортсмен у **Safety Area** за правилами.
- Користуватися текстом **Handgun** **без** відкритого **PDF PCC**.
