...
control_values: "Перевірити PDF Mini Rifle Jan 2026 — розділ 6 (етапи, команди, класи, кваліфікація тощо)"
...
**Розділ 6** **IPSC Mini Rifle** описує **організацію змагань**: етапи, **команди**, **категорії**, правила переходу між етапами. RO на лінії зазвичай **не** будує сітку, але має **розуміти** межі етапів, кількість **спроб** і куди **направити** питання про **клас** / **команду**. **C280** — **Handgun**; для **розділу 6** потрібен **PDF Mini Rifle** (не припускати структуру **повного Rifle** або handgun без читання).
...
- Користуватися **Handgun** або **повним Rifle** **Ch.6** **без** відкритого **PDF Mini Rifle**.
