...
Спрощення на шкільних / клубних матчах **не** прибирають обов’язкові мішені без повноважень **MD** у межах рівня правил. **`fpsu_delta_verified`**: **true** до рев’ю за **RO_HELPER_V0 §4.1**.
