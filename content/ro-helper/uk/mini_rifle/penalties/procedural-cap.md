...
control_values: "Перевірити PDF Mini Rifle Jan 2026 — 10.2.3 (об’єкт обмеження: постріл/мішень/сцена тощо)"
ipsc_edition: "Jan 2026"
ipsc_refs:
  - rule: "10.2.3"
    note: "Максимум procedural у певному контексті — Mini Rifle Jan 2026; лише з PDF"
...
- Якір — **10.2.3** у **Mini Rifle**; читати разом із підпунктами, на які посилається обмеження.
