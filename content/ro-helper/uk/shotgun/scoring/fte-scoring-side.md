...
locale: uk
discipline: shotgun
control_values: "Перевірити PDF Shotgun Jan 2026 — 9.5.6 разом із 10.2.7 (залік vs procedural)"
...
**FTE (failure to engage)** має **два шари** у правилах: **скоринг** (**9.5.6**) і **процедурний штраф** (**10.2.7** — див. картку **C36**). Ця картка про **заліковку**: як записати необстріляну мішень, скільки **miss**, як взаємодіє з **металом** / **папером** тощо — **лише з PDF Shotgun Jan 2026**. Для handgun-дубля див. **C190**. RO має **не плутати** «немає отвору» з іншими випадками (не той тип мішені, не зарахований knockdown).

## Що робить суддя змагань (RO)

1. **Переконатися**, що мішень **має бути** обстріляна за **WSB** (не опціональна зона).
2. **Зафіксувати** на листі формат, який вимагає скоринг: кількість **miss** / **FTE** / комбінації за **9.5.6 Shotgun**.
...
- **9.5.6 Shotgun** + **10.2.7** читати **разом**; порядок застосування — за текстом PDF. Для **Shotgun** використовуйте **розділ 9 Shotgun**, а не лише спогади про **handgun**.
...
- **Перенесення handgun-прикладів з C190**, коли формулювання **Shotgun** відрізняються.
