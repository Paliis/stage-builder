...
- **MA-E01/E02** — публічна картка, блок **«Програма»**: таблиця статистики вправ + кнопка **завантажити брифінги матчу** (PDF); **MA-E03** — зведення дивізіон/клас ([MATCH_BRIEFINGS_PACKAGE_PLAN.md](./MATCH_BRIEFINGS_PACKAGE_PLAN.md)).
