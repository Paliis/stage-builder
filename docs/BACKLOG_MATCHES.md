...
| **MA-P01** | `organizer_payment_providers` + Vault; UI «Підключити оплату» в профілі організатора | idea | — | Модель A |
| **MA-P02** | Секція «Внесок» на картці матчу (режим офлайн/онлайн/обидва, сума) | idea | — | |
| **MA-P03** | API `create-payment` + webhook **LiqPay** | idea | — | |
| **MA-P04** | API + webhook **Monobank Acquiring** | idea | — | |
| **MA-P05** | UI стрільця «Сплатити онлайн» + return URL | idea | — | |
