...
| Дата | Зміни |
|------|--------|
| 2026-05-05 | Ростер організатора: **`payment_received`** (Так/Ні), колонка «Оплата»; **`payment_note`** лишається як текст; міграція `20260518110000_match_registration_payment_received.sql`. |
