...
12. **`supabase/migrations/20260511100000_match_event_kind_ps_match_level.sql`** — **`matches.match_event_kind`** (тренування / матч / класифікація) та **`matches.ps_match_level`** (`L1`–`L5`, PractiScore), обидва **nullable**.
