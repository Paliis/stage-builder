...
- **2D план** — панорама, зум, міні-карта, переміщення, обертання; `[`/`]` для зміни сторони металевої пластини; **закріплені розміри** між центрами об’єктів (кнопка «Розміри») зберігаються у файлі впраси для однакового відтворення сцени організаторами.
