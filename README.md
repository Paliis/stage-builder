...
- **2D план** — панорама, зум, міні-карта, переміщення, обертання; `[`/`]` для зміни сторони металевої пластини; **закріплені розміри** між двома довільними точками поля (кнопка «Розміри», два кліки по плану) зберігаються у файлі впраси для однакового відтворення сцени організаторами.
