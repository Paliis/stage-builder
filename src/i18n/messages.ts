...
export type MessageTree = {
  ...
  view: {
    ...
    camOverview: string
    camShooter: string
    /** Перемикач точок огляду, коли на плані кілька стартових позицій. */
    camShooterPointAria: string
    camShooterPoint: string
    camShooterPrev: string
    camShooterNext: string
...
export const ukMessages: MessageTree = {
  ...
  view: {
    ...
    camShooterPointAria:
      '\u0422\u043e\u0447\u043a\u0430 \u043e\u0433\u043b\u044f\u0434\u0443 \u0441\u0442\u0440\u0456\u043b\u044c\u0446\u044f',
    camShooterPoint: '\u0421\u0442\u0430\u0440\u0442',
    camShooterPrev:
      '\u041f\u043e\u043f\u0435\u0440\u0435\u0434\u043d\u044f \u0441\u0442\u0430\u0440\u0442\u043e\u0432\u0430 \u043f\u043e\u0437\u0438\u0446\u0456\u044f',
    camShooterNext:
      '\u041d\u0430\u0441\u0442\u0443\u043f\u043d\u0430 \u0441\u0442\u0430\u0440\u0442\u043e\u0432\u0430 \u043f\u043e\u0437\u0438\u0446\u0456\u044f',
    camPdf: '\u042f\u043a \u0443 PDF',
    camPdfTitle:
  ...
  portal: {
    ...
    matchOrgStagesIntro: 'Вправи з Stage Builder, PDF програми та коли показати їх на картці.',
    matchOrgStagesZoneSbTitle: '1. Вправи з Stage Builder',
    matchOrgStagesZoneSbIntro: 'Додай із «Моїх вправ» або встав view-посилання.',
    matchOrgStagesZonePdfTitle: '2. PDF-брифінг програми',
    matchOrgStagesZonePdfInformer:
      'Лише PDF — на картці не буде схем і статистики окремих вправ. Додай їх у кроці 1.',
    matchOrgStagesZoneVisibilityTitle: '3. Коли показати на картці',
    matchOrgStagesLinkedListHeading: 'Додані вправи',
    matchOrgStagesOpenEditor: 'Stage Builder',
    matchOrgStagesLibraryLabel: 'Мої вправи',
    matchOrgStagesLibraryHint: 'Додавання створює посилання перегляду.',
    matchOrgStagesLibraryPlaceholder: 'Обери вправу…',
    matchOrgStagesLibraryLoading: 'Завантаження…',
    matchOrgStagesLibraryEmpty: 'Немає збережених вправ',
    matchOrgStagesLibraryUntitled: 'Без назви',
    matchOrgStagesLibraryAdd: 'Додати',
    matchOrgStagesLibraryPickRequired: 'Обери вправу зі списку.',
    matchOrgStagesLibraryNeedSignIn: 'Увійди, щоб бачити «Мої вправи».',
    matchOrgStagesLibraryUnavailable: 'Хмарна бібліотека недоступна.',
    matchOrgStagesLibraryLoadError: 'Не вдалося завантажити «Мої вправи».',
    matchOrgStagesLibraryNotFound: 'Вправу видалено з бібліотеки.',
    matchOrgStagesLibraryPublishRateLimited: 'Забагато публікацій сьогодні. Спробуй пізніше.',
    matchOrgStagesLibraryPublishTooLarge: 'Вправа завелика для публікації.',
    matchOrgStagesLibraryPublishNotConfigured: 'Публікація посилань не налаштована.',
    matchOrgStagesLibraryPublishNetwork: 'Мережева помилка під час публікації.',
    matchOrgStagesPasteLabel: 'Посилання / id',
    matchOrgStagesPastePlaceholder: 'https://…/v/s… або s…',
    matchOrgStagesAdd: 'Додати',
    matchOrgStagesAdding: 'Додавання…',
    matchOrgStagesEmpty: 'Ще немає вправ — додай із «Моїх вправ» або за посиланням.',
    ...
    matchOrgStagesRefreshAll: 'Оновити до останніх',
    matchOrgStagesRefreshAllBusy: 'Оновлення…',
    matchOrgStagesErrorGeneric: 'Операцію не виконано. Перезавантаж сторінку.',
    matchOrgStagesInvalidPaste: 'Потрібен URL з /v/… або короткий id (s…).',
    matchOrgStagesNotFound: 'Вправу не знайдено або термін посилання минув.',
    matchOrgStagesNotViewMode:
      'Потрібне посилання перегляду (view), не edit.',
    matchOrgStagesDuplicate: 'Цей share уже в програмі.',
    matchOrgStagesErrNoShareGroup:
      'Немає групи версій — додай вправу знову.',
    matchOrgStagesErrNoLatestShare:
      'Немає актуального view у цій групі — опублікуй знову.',
    matchOrgStagesVisibleDaysLabel: 'Днів до події',
    matchOrgStagesVisibleDaysHint: '0 — одразу; порожньо — приховано без дати.',
    matchOrgStagesVisibleDaysPlaceholder: 'напр. 6',
    matchOrgStagesVisibleDaysSaving: 'Збереження…',
    matchOrgStagesVisibleDaysSaveError: 'Не вдалося зберегти термін публікації.',
    matchOrgStagesVisibleFromPreview: 'На картці з {{date}}',
    matchOrgProgrammePdfLabel: 'Файл PDF',
    matchOrgProgrammePdfHint: 'До 15 МБ.',
    matchOrgProgrammePdfUpload: 'Завантажити',
    matchOrgProgrammePdfReplace: 'Замінити',
    matchOrgProgrammePdfUploading: 'Завантаження…',
    matchOrgProgrammePdfOpen: 'Відкрити',
    matchOrgProgrammePdfRemove: 'Прибрати',
    matchOrgProgrammePdfRequired: 'Обери файл PDF.',
    matchOrgProgrammePdfInvalid: 'Потрібен файл PDF.',
...
export const enMessages: MessageTree = {
  ...
  view: {
    ...
    camShooterPointAria: 'Shooter viewpoint',
    camShooterPoint: 'Start',
    camShooterPrev: 'Previous start position',
    camShooterNext: 'Next start position',
    camPdf: 'PDF frame',
    camPdfTitle:
  ...
  portal: {
    ...
    matchOrgStagesIntro: 'Stage Builder exercises, a programme PDF, and when to show them on the card.',
    matchOrgStagesZoneSbTitle: '1. Exercises from Stage Builder',
    matchOrgStagesZoneSbIntro: 'Add from My stages or paste a view link.',
    matchOrgStagesZonePdfTitle: '2. Programme briefing PDF',
    matchOrgStagesZonePdfInformer:
      'PDF only — no per-stage diagrams or stats on the card. Add stages in step 1.',
    matchOrgStagesZoneVisibilityTitle: '3. When to show on the card',
    matchOrgStagesLinkedListHeading: 'Linked exercises',
    matchOrgStagesOpenEditor: 'Stage Builder',
    matchOrgStagesLibraryLabel: 'My stages',
    matchOrgStagesLibraryHint: 'Adding creates a view link.',
    matchOrgStagesLibraryPlaceholder: 'Choose a stage…',
    matchOrgStagesLibraryLoading: 'Loading…',
    matchOrgStagesLibraryEmpty: 'No saved stages',
    matchOrgStagesLibraryUntitled: 'Untitled',
    matchOrgStagesLibraryAdd: 'Add',
    matchOrgStagesLibraryPickRequired: 'Choose a stage from the list.',
    matchOrgStagesLibraryNeedSignIn: 'Sign in to see My stages.',
    matchOrgStagesLibraryUnavailable: 'Cloud library unavailable.',
    matchOrgStagesLibraryLoadError: 'Could not load My stages.',
    matchOrgStagesLibraryNotFound: 'That stage was removed from the library.',
    matchOrgStagesLibraryPublishRateLimited: 'Too many publishes today. Try later.',
    matchOrgStagesLibraryPublishTooLarge: 'Stage is too large to publish.',
    matchOrgStagesLibraryPublishNotConfigured: 'Share publish is not configured.',
    matchOrgStagesLibraryPublishNetwork: 'Network error while publishing.',
    matchOrgStagesPasteLabel: 'Link / id',
    matchOrgStagesPastePlaceholder: 'https://…/v/s… or s…',
    matchOrgStagesAdd: 'Add',
    matchOrgStagesAdding: 'Adding…',
    matchOrgStagesEmpty: 'No exercises yet—add from My stages or by link.',
    ...
    matchOrgStagesRefreshAll: 'Refresh to latest',
    matchOrgStagesRefreshAllBusy: 'Updating…',
    matchOrgStagesErrorGeneric: 'Something went wrong. Reload the page.',
    matchOrgStagesInvalidPaste: 'Need a /v/… URL or short id (s…).',
    matchOrgStagesNotFound: 'Stage not found or link expired.',
    matchOrgStagesNotViewMode: 'Only view links work here, not edit.',
    matchOrgStagesDuplicate: 'That share is already in the programme.',
    matchOrgStagesErrNoShareGroup: 'Missing version group—add the stage again.',
    matchOrgStagesErrNoLatestShare: 'No current view in this group—publish again.',
    matchOrgStagesVisibleDaysLabel: 'Days before event',
    matchOrgStagesVisibleDaysHint: '0 = show now; empty = stay hidden.',
    matchOrgStagesVisibleDaysPlaceholder: 'e.g. 6',
    matchOrgStagesVisibleDaysSaving: 'Saving…',
    matchOrgStagesVisibleDaysSaveError: 'Could not save visibility schedule.',
    matchOrgStagesVisibleFromPreview: 'On card from {{date}}',
    matchOrgProgrammePdfLabel: 'PDF file',
    matchOrgProgrammePdfHint: 'Max 15 MB.',
    matchOrgProgrammePdfUpload: 'Upload',
    matchOrgProgrammePdfReplace: 'Replace',
    matchOrgProgrammePdfUploading: 'Uploading…',
    matchOrgProgrammePdfOpen: 'Open',
    matchOrgProgrammePdfRemove: 'Remove',
    matchOrgProgrammePdfRequired: 'Choose a PDF file.',
    matchOrgProgrammePdfInvalid: 'PDF file required.',
